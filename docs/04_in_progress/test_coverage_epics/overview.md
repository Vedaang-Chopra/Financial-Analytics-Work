...
122 passed, 3 skipped (2026-06-27)

## Epic Status

| Epic | Name | Tasks | Done | Pending | Batch file |
|---|---|---|---|---|---|
| G | Validation coverage | 6 | 0 | 6 | `docs/06_plans/active/BATCH_E_validation.md` |
| H | Discovery / relevance | 5 | 0 | 5 | `docs/06_plans/active/BATCH_F_discovery.md` |
| I | Browser tests | 2 | 0 | 2 | `docs/06_plans/active/BATCH_G_browser_vlm.md` |
| J | Network / API discovery | 2 | 0 | 2 | `docs/06_plans/active/BATCH_G_browser_vlm.md` |
| K | VLM tests | 5 | 1 | 4 | backlog (K001-K003, K005) |
| L | Raw retention | 3 | 1 | 2 | `docs/06_plans/backlog/BATCH_I_retention.md` |
| M | Dataset classification | 1 | 0 | 1 | `docs/06_plans/backlog/BATCH_J_nav.md` |
| N | NAV ingestion | 4 | 1 | 3 | `docs/06_plans/backlog/BATCH_J_nav.md` |
| O | AMC / scheme master | 3 | 0 | 3 | `docs/06_plans/backlog/BATCH_K_scheme_amc.md` |
| P | Portfolio parser | 4 | 2 | 2 | `docs/06_plans/backlog/BATCH_L_portfolio.md` |
| Q | Metadata parser stubs | 3 | 0 | 3 | `docs/06_plans/backlog/BATCH_M_metadata.md` |

**Total pending**: 32 tasks → expected to add ~32 tests → projected count: ~154
